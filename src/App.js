...
// ✅ FIX 1: ลบ ChevronDown ออก เพราะไม่ได้ใช้
...
// ✅ FIX 2: ลบ calculateBudgetStats ออก เพราะไม่ได้ใช้
...
const LocalDevPlanChecker = () => {
  ...
  // ✅ FIX 3: wrap projects ใน useMemo เพื่อไม่ให้ re-create array ทุก render
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-slate-50 to-blue-100">
      ...
      <style>{`
        ...
        .custom-scrollbar::-webkit-scrollbar-thumb { background: #2563eb; border-radius: 4px; }
